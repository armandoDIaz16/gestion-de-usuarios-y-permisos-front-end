...
@Component({
    templateUrl: './usuarioComiteAcademico-Form.component.html'
  })

  export class UsuariosComiteAcademicoFormComponent {
    ...
    agregar(pk_usuario){
        this.creditosService.AgregarUsuarioCA(pk_usuario).subscribe(
