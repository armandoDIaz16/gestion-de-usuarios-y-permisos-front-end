...
export class PeriodoService extends GenericServicesService {
    ...
    async addPeriodoInscripcion(fechas) {
        return this.http.post(
            GenericServicesService.API_ENDPOINT + 'PeriodoInscripcion',
            fechas,
            GenericServicesService.HEADERS).toPromise();
    }

    async addPeriodoInscripcionCero(fechas) {
        return this.http.post(
            GenericServicesService.API_ENDPOINT + 'PeriodoInscripcionCero',
            fechas,
            GenericServicesService.HEADERS).toPromise();
    }
